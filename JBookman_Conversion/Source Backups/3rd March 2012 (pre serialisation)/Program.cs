    ...
    class Game : GameWindow
    {
     ...
     /*   private void HandleKeyPressEvent(object sender, OpenTK.KeyPressEventArgs e)
        ...
        public void InitGame()
        {
            ...
            g_FirstMap = new CMap(m_sFirstMap);
      ...
      private void DrawTiles()
        {
         ...
         ushort[,] m_MapSectors = g_CurrentMap.m_MapSectors;
...
///////////////////////
    ...
    private bool PlayerBlocked(int iPlayerSector, Constants.g_iDirection direction)
    {
        ...
        int item = g_CurrentMap.m_MapSectors[y, x];

        Constants.g_iMapTypeEnum mapType = (Constants.g_iMapTypeEnum)g_CurrentMap.m_MapTypeID;
